...
export const metadata = {
  ...
  description:
    "Turn every AI conversation into permanent, organized, searchable knowledge. Your personal Scroll Library grows as you learn.",
};
...
const FEATURES = [
  {
    ...
    description:
      "Gemini 2.5 Flash automatically suggests which folder to file every scroll — programming, medicine, recipes, or any topic.",
  ...
  },
  {
    ...
    description:
      "Find scrolls by meaning, not just keywords. Vector embeddings convert your knowledge into searchable dimensions stored in Aurora pgvector.",
    highlight: "pgvector + Aurora",
  },
  {
    icon: FolderTree,
    title: "Hierarchical Scroll Library",
    description:
...
const HOW_IT_WORKS = [
  {
    step: "01",
    title: "Ask anything",
    body: "Type any question in the chat. Gemini 2.5 Flash answers with expert, concise knowledge.",
  },
  {
    step: "02",
    title: "AI suggests where to save",
    body: "The AI reads your Scroll Library and suggests the best folder — or proposes creating a new one.",
  },
  {
    step: "03",
    title: "Your knowledge grows",
    body: "The answer is rewritten as a clean, evergreen scroll and saved to Aurora PostgreSQL with vector embeddings.",
  },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 text-gray-900 dark:text-slate-100">
      ...
      <section className="max-w-4xl mx-auto px-6 pt-20 pb-16 text-center">
        <div className="inline-flex items-center gap-2 bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800/30 rounded-full px-4 py-1.5 text-xs text-amber-600 dark:text-amber-400 mb-8">
          ...
          Built for the AWS H0 Hackathon · Aurora PostgreSQL + Gemini 2.5 Flash
        </div>
        ...
        <p className="text-lg text-gray-600 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
          ...
          Ask questions on the left. Watch your personal Scroll Library grow on the right.
        </p>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-gray-50 dark:bg-slate-950 rounded-lg p-3 border border-gray-200 dark:border-slate-800">
              ...
              <div className="mt-2 bg-gray-50 dark:bg-slate-800/40 border border-amber-200 dark:border-amber-600/20 rounded-lg p-2 text-xs text-amber-600 dark:text-amber-400">
                📜 Save as Scroll to programming.dotnet?
              </div>
            </div>
            <div className="bg-gray-50 dark:bg-slate-950 rounded-lg p-3 border border-gray-200 dark:border-slate-800">
              <div className="text-xs text-gray-400 dark:text-slate-500 mb-2">Scroll Library</div>
        ...
        <div className="rounded-2xl border border-amber-200 dark:border-amber-800/30 bg-amber-50 dark:bg-amber-950/20 p-8 flex flex-col md:flex-row items-center gap-6">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-slate-400 text-sm leading-relaxed">
              Before the AI answers, ChatScroll checks your Scroll Library for similar scrolls using
              pgvector semantic similarity. If you&apos;ve already saved an answer, you&apos;ll see which scroll
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <Link
                href={plan.name === "Business" ? "mailto:hello@chatscroll.app" : "/login"}
