...
builder.Services.AddControllers()
    .AddJsonOptions(opts =>
    {
        // EF relationship fixup creates bidirectional cycles (e.g. Folder ↔ Folder.Children).
        // IgnoreCycles breaks cycles during serialization instead of throwing a 500.
